...
<html>
    ...
    <body>
       <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="container">
            <h2>Fund Transfer</h2>
            <form action="{{ url('fund-user') }}" method="get">
              ...
              <div class="form-group">
                <label for="accnum">Your Account Number</label>
                <input type="text" class="form-control" name="accnum2" id="accnum" placeholder="accountnum" value={{ $data->accountnum }} readonly>
                <small>Please Note you account number</small>
                <span class="text-danger">@error('email'){{ $message }} @enderror</span>
              </div>
              <div class="form-group">
                <label for="accnum">Account Number</label>
                <input type="text" class="form-control" name="accnum" id="accnum" placeholder="accountnum" required>
                <small>Please Note you account number</small>
                <span class="text-danger">@error('email'){{ $message }} @enderror</span>
              </div>
