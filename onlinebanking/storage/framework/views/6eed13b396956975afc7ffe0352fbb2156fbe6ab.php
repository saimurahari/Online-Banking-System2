    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            ...
            <a class="nav-item nav-link disabled" href="#" tabindex="-1" aria-disabled="true"><?php echo e($data->name); ?></a>
      ...
      <div class="container">
          ...
          <div class="button-container">
              ...
              <a class="btn btn-success">Login Net account</a>
          </div>
      </div>
</body>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Laravel/Online-Banking-System2/onlinebanking/resources/views/auth/dashboard.blade.php ENDPATH**/ ?>